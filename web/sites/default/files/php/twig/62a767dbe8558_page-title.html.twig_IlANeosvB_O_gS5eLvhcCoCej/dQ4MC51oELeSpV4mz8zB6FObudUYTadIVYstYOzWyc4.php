...
class __TwigTemplate_03ff5dfd3f2e7f901c37446fd17a1f3ffc6e0e1945672531f47bcba410b0aec5 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (($context["title"] ?? null)) {
            // line 19
            echo "  <h1";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", [0 => "title"], "method", false, false, true, 19), 19, $this->source), "html", null, true);
            echo ">";
...
";
    ...
    {
        return new Source("", "themes/contrib/bootstrap_barrio/templates/content/page-title.html.twig", "/var/www/html/web/themes/contrib/bootstrap_barrio/templates/content/page-title.html.twig");
    }
